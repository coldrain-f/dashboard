        ...
        <div style={{
          ...
          <div style={{ display: "flex" }}>
            <Label style={{
              ...
              <span className="text-stone-900">9월</span> 지출 총액
            </Label>
            <Input type="text" id="email" placeholder="" autoComplete="off" style={{ backgroundColor: '#ffffff' }} readOnly />
          </div>
          <div style={{ display: "flex" }}>
            <Label style={{
              whiteSpace: 'nowrap',
            ...
            <Input type="email" id="email" placeholder="" autoComplete="off" style={{ backgroundColor: '#ffffff' }} readOnly />
          </div>
          <div style={{ display: "flex" }}>
            <Label style={{
              whiteSpace: 'nowrap',
          ...
          <div style={{ display: "flex" }}>
            ...
            {/* <Checkbox className="bg-background data-[state=checked]:bg-primary mt-2" /> */}
          ...
          <div style={{ display: "flex" }}>
            <Label style={{
              ...
              <span className="text-stone-900">8월</span> 지출 총액
            </Label>
            <Input type="text" id="email" placeholder="" autoComplete="off" style={{ backgroundColor: '#ffffff' }} readOnly />
          </div>
          <div style={{ display: "flex" }}>
