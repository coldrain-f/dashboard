...
const columns: Column<RequestData>[] = [
    { id: "job", name: "직업", width: 120, cellRenderer: InputCell },
    { id: "age", name: "나이", type: "number", width: 80, cellRenderer: InputCell },
    { id: "balance", name: "밸런스", type: "number", cellRenderer: InputCell },
    { id: "education", name: "학력", cellRenderer: InputCell },
    { id: "marital", name: "결혼여부", cellRenderer: InputCell },
    { id: "default", name: "기본", cellRenderer: InputCell },
    { id: "housing", name: "호스팅", cellRenderer: InputCell },
    { id: "loan", name: "대출", cellRenderer: InputCell },
    { id: "contact", name: "연락수단", cellRenderer: InputCell },
    { id: "day", name: "일", type: "number", cellRenderer: StatusCell },
    { id: "month", name: "월", cellRenderer: InputCell },
    { id: "duration", type: "number", name: "지속시간", cellRenderer: InputCell },
    { id: "poutcome", name: "P Outcome", cellRenderer: InputCell },
    { id: "y", name: "Y", cellRenderer: InputCell },
];
